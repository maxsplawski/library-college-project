...
class TestCommandLineInterfaceView(unittest.TestCase):
    def setUp(self):
        self.mock_auth_domain = Mock()
        self.mock_book_domain = Mock()
        self.cli_view = CommandLineInterfaceView(self.mock_auth_domain, self.mock_book_domain)
    ...
    def test_user_can_login(self, mock_print: MagicMock, mock_getpass: MagicMock, mock_input: MagicMock):
        self.mock_auth_domain.login.return_value = True

        result = self.cli_view.attempt_login()

        self.assertTrue(result)
        self.mock_auth_domain.login.assert_called_once_with("user@example.com", "password")
    ...
    def test_user_is_shown_error_message_on_login_failure(self, mock_print: MagicMock, mock_getpass: MagicMock,
        ...
        self.mock_auth_domain.login.return_value = False
    ...
    def test_user_can_sign_up(self, mock_print: MagicMock, mock_getpass: MagicMock, mock_input: MagicMock):
        self.mock_auth_domain.get_user.return_value = None
        self.mock_auth_domain.register.return_value = None

        self.cli_view.attempt_registration()

        self.mock_auth_domain.get_user.assert_called_with("user@example.com")
        self.mock_auth_domain.register.assert_called_with("user@example.com", "password")
    ...
    def test_user_is_shown_error_message_on_email_taken(self, mock_print: MagicMock, mock_getpass: MagicMock,
                                                        mock_input: MagicMock):
        self.mock_auth_domain.get_user.side_effect = lambda email: MagicMock() if email == "user@example.com" else None
        self.mock_auth_domain.register.return_value = None

        self.cli_view.attempt_registration()

        self.mock_auth_domain.get_user.assert_called_with("user@company.com")
    ...
    def test_user_can_get_books(self, mock_print: MagicMock):
        ...
        self.mock_book_domain.get_books.return_value = books

        self.cli_view.route_command("1")

        self.mock_book_domain.get_books.assert_called_once()
    ...
    def test_user_can_get_book(self, mock_print: MagicMock, mock_input: MagicMock):
        ...
        self.mock_book_domain.get_book.return_value = book

        self.cli_view.route_command("2")

        self.mock_book_domain.get_book.assert_called_with("1234")
        mock_print.assert_any_call(book)
    ...
    def test_user_is_shown_error_message_when_book_not_found_on_get_book_attempt(self, mock_print: MagicMock,
                                                                                 mock_input: MagicMock):
        self.mock_book_domain.get_book.return_value = None
    ...
    def test_user_can_add_book(self, mock_print: MagicMock, mock_input: MagicMock):
        book = Book(1, "1234", "Author 1", "Title 1", 10)
        self.mock_book_domain.add_book.return_value = book

        self.cli_view.route_command("3")

        # self.mock_book_domain.add_book.assert_called_with(Book(ANY, "1234", "Author 1", "Title 1", 10))
    ...
    def test_user_can_update_book(self, mock_print: MagicMock, mock_input: MagicMock):
        ...
        self.mock_book_domain.get_book.return_value = book
        self.mock_book_domain.update_book.return_value = updated_book

        self.cli_view.route_command("4")

        self.mock_book_domain.get_book.assert_called_with("1234")
        self.mock_book_domain.update_book.assert_called_with(book)
    ...
    def test_user_is_shown_error_message_when_book_not_found_on_book_update_attempt(self, mock_print: MagicMock,
        ...
        self.mock_book_domain.get_book.assert_called_with("1234")
        self.mock_book_domain.update_book.assert_not_called()
        mock_print.assert_any_call("No book found")
    ...
    def test_user_can_delete_book(self, mock_print: MagicMock, mock_input: MagicMock):
        ...
        self.mock_book_domain.delete_book.assert_called_with("1234")
    ...
    def test_user_is_shown_error_message_when_book_not_found_on_book_delete_attempt(self, mock_print: MagicMock,
        ...
        self.mock_book_domain.get_book.assert_called_with("1234")
        self.mock_book_domain.delete_book.assert_not_called()
        mock_print.assert_any_call("No book found")

    @patch("builtins.print")
    def test_user_can_export_books(self, mock_print: MagicMock):
        self.mock_book_domain.export_books.return_value = None

        self.cli_view.route_command("6")

        self.mock_book_domain.export_books.assert_called_with(EXPORT_DESTINATION)
